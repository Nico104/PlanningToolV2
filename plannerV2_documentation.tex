...
Tabelle~\ref{tab:nichtfunktionale-anforderungen} fasst diese Anforderungen zusammen.
...
Die Tabellen~\ref{tab:test-stammdaten} bis~\ref{tab:test-kalender-dragdrop} zeigen eine Auswahl der durchgeführten manuellen Tests, gegliedert nach Funktionsbereichen.
